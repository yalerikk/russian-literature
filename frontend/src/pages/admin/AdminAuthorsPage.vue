  ...
  <div class="admin-page">
    <div class="admin-content">
      ...
      <div class="page-header">
        ...
        <button class="add-button" @click="openCreateModal">Добавить автора</button>
      </div>
      ...
      >
        ...
        <template #cell-lifeDates="{ item }">
          {{ formatBirthDeath(item) }}
        </template>
    ...
    <AuthorModal ref="authorModal" @saved="loadItems" />
...
const columns = [
  ...
  { key: 'lifeDates', label: 'Даты жизни' },
